...
public class InternalPetrinet2Lexer extends Lexer {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:697:13: ( ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? )
            // InternalPetrinet2.g:697:15: ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )?
            {
            // InternalPetrinet2.g:697:15: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalPetrinet2.g:697:16: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            // InternalPetrinet2.g:697:27: ( '.' ( '0' .. '9' )+ )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalPetrinet2.g:697:28: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalPetrinet2.g:697:32: ( '0' .. '9' )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
                        ...
                        switch (alt2) {
                    	case 1 :
                    	    // InternalPetrinet2.g:697:33: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:699:10: ( 'this one has been deactivated' )
            // InternalPetrinet2.g:699:12: 'this one has been deactivated'
            {
    ...
    public final void mRULE_GREATER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:701:14: ( '>' )
            // InternalPetrinet2.g:701:16: '>'
            {
            match('>'); 
    ...
    public final void mRULE_LESS() throws RecognitionException {
        try {
            int _type = RULE_LESS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:703:11: ( '<' )
            // InternalPetrinet2.g:703:13: '<'
            {
            match('<'); 
    ...
    public final void mRULE_SLASH() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:705:12: ( '/' )
            // InternalPetrinet2.g:705:14: '/'
            {
            match('/'); 
    ...
    public final void mRULE_TPLACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:707:13: ( 'place' )
            // InternalPetrinet2.g:707:15: 'place'
            {
            match("place"); 
    ...
    public final void mRULE_TTRANSITION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:709:18: ( 'transition' )
            // InternalPetrinet2.g:709:20: 'transition'
            {
            match("transition"); 
    ...
    public final void mRULE_TOUTPUTARC() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:711:17: ( 'outputarc' )
            // InternalPetrinet2.g:711:19: 'outputarc'
            {
            match("outputarc"); 
    ...
    public final void mRULE_TINPUTARC() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:713:16: ( 'inputarc' )
            // InternalPetrinet2.g:713:18: 'inputarc'
            {
            match("inputarc"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:715:9: ( 'id' )
            // InternalPetrinet2.g:715:11: 'id'
            {
            match("id"); 
    ...
    public final void mRULE_EQUALS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:717:13: ( '=' )
            // InternalPetrinet2.g:717:15: '='
            {
            match('='); 
    ...
    public final void mRULE_QUESTION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:719:15: ( '?' )
            // InternalPetrinet2.g:719:17: '?'
            {
            match('?'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:721:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalPetrinet2.g:721:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalPetrinet2.g:721:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalPetrinet2.g:721:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalPetrinet2.g:721:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalPetrinet2.g:721:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalPetrinet2.g:721:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:723:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPetrinet2.g:723:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPetrinet2.g:723:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:725:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPetrinet2.g:725:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPetrinet2.g:725:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:727:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPetrinet2.g:727:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPetrinet2.g:727:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPetrinet2.g:729:16: ( . )
            // InternalPetrinet2.g:729:18: .
            {
            matchAny(); 
